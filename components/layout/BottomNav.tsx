...
export function BottomNav({ savedCount = 0 }: Props) {
  ...
  return (
    <nav className="fixed bottom-0 inset-x-0 h-[60px] bg-white/95 backdrop-blur-[8px] border-t border-[var(--color-border)] pb-[env(safe-area-inset-bottom)] flex z-50 shadow-[0_-5px_20px_rgba(0,0,0,0.05)]">
      {tabs.map((tab) => {
